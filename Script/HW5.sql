...
SELECT RANK()
	   OVER(
	   		ORDER BY customer_rental_payment.rental_count DESC, 
	   				 customer_rental_payment.avg_payment DESC
	   	   ) AS customer_rank,
	   customer_rental_payment.customer_name,
	   customer_rental_payment.rental_count,
	   customer_rental_payment.avg_payment
